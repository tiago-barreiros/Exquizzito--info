...
# Exquizzito: Mais um jogo de quizzes

<table>
<tr>
<td>

> Esta aplicação pretende ser uma versão virtual dos jogos clássicos de cultura geral com
cartões de perguntas de resposta múltipla. Neste caso as perguntas devem ter um âmbito
muito concreto: programação de dispositivos móveis com sistema operativo Android.
...
[![Java][Java]][Java-url] [![JavaScript][JavaScript]][JavaScript-url] [![Android-Studio][Android-Studio]][Android-Studio-url] [![Firebase][Firebase]][Firebase-url]
